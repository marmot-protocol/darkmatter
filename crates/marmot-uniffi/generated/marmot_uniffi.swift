...
private var initializationResult: InitializationResult = {
    ...
    if (uniffi_marmot_uniffi_checksum_method_marmot_list_accounts() != 44995) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_marmot_uniffi_checksum_method_marmot_shutdown() != 14638) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_marmot_uniffi_checksum_method_marmot_start() != 58246) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_marmot_uniffi_checksum_constructor_marmot_new() != 20541) {
        return InitializationResult.apiChecksumMismatch
    }
