//! Local CLI preferences. Stored in a private per-home `settings.json` file;
...
use crate::{CommandOutput, DmError, write_private_file};
...
pub(crate) fn run(home: &Path, command: SettingsCommand) -> Result<CommandOutput, DmError> {
