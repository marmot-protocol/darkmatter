...
An inviter adds a new member to an existing group by committing an MLS Add that uses the invitee's KeyPackage. The
resulting group-state change MUST be published before the inviter sends the Welcome.
